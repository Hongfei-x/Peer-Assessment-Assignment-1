...
# plt.ylabel('异常数量')
# plt.savefig('F:/迅雷下载/10G_data/country_address_correction.png')
...
# plt.title('处理后年龄分布')
# plt.tight_layout()
# plt.savefig('F:/迅雷下载/10G_data/age_correction.png')
...
# plt.tight_layout()
# plt.savefig('F:/迅雷下载/10G_data/purchase_category_price_distribution.png')
...
# plt.tight_layout()
# plt.savefig('F:/迅雷下载/10G_data/purchase_category_price_heatmap.png')
...
# plt.tight_layout()
# plt.savefig('F:/迅雷下载/10G_data/purchase_by_age.png')

# # 3. 统计每个年龄段的平均购买价格
# avg_price_by_age = data.groupby('age_group')['average_price'].mean().round(2)
...
# plt.tight_layout()
# plt.savefig('F:/迅雷下载/10G_data/avg_price_by_age.png')
...
# plt.title('信用评分分布')
# plt.tight_layout()
# plt.savefig('F:/迅雷下载/10G_data/credit_score_distribution.png')
...
# 加载Parquet文件
data = pd.read_parquet('F:/迅雷下载/10G_data/part-00000.parquet')
